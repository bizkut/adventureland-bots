...
const MERCHANT: string = "Speedmart" // earthMer, earthMer2, earthMer3
const WARRIORS: string[] = [] // earthWar, earthWar2, earthWar3
const MAGES: string[] = ["Bwizzard"] // earthMag, earthMag2, earthMag3
const PRIESTS: string[] = ["Cekmek"] // earthPri, earthPri2
